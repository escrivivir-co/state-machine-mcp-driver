    ...
    if (narratorAgent) {
      const actionResult = await runtime.executeAction({
        ...
        params: {
          ...
          tone: 'mysterious',
          elements: ['ancient trees', 'glowing mushrooms', 'distant sounds']
        },
        timestamp: Date.now()
      });
      ...
      agentConfigs: [
        {
          ...
          config: {
            ...
            allowedActions: ['narrate', 'describe', 'set_scene', 'control_npc', 'trigger_event']
          }
        },
        {
          id: 'combat-manager',
          ...
          config: {
            ...
            allowedActions: ['roll_dice', 'calculate_damage', 'apply_effects', 'check_conditions']
          }
        },
        {
          id: 'player-assistant',
          ...
          config: {
            ...
            allowedActions: ['suggest_action', 'explain_rule', 'provide_hint', 'show_inventory']
          }
        }
      ]
    };
      ...
      if (dmAgent) {
        await runtime.executeAction({
          ...
          params: {
            ...
            npcs: ['bartender', 'mysterious_stranger', 'local_merchant']
          },
          timestamp: Date.now()
        });
      }
