    ...
    private publishEvent(event: any): void {
        this.eventListeners.forEach((listener) => {
            try {
                ...
                Logger.mcpError("Error in event listener", {
                    error,
                    event: event.type,
                });
            }
    ...
    private setupTools(): void {
        ...
        this.server.tool(
            ...
            async ({ reason, metadata }) => {
                ...
                Logger.mcpVerbose(`X reset: ${previousX} → 0`, {
                    reason,
        ...
        this.server.tool(
            ...
            async ({ text, context }) => {
                ...
                Logger.mcpVerbose("Remote command queued", {
                    type: "user_input",
        ...
        this.server.tool(
            ...
            {},
            async () => {
                Logger.mcpVerbose("Conversation data requested", {
        ...
        this.server.tool(
            ...
            {},
            async () => {
                Logger.mcpVerbose("Available postulations requested", {
        ...
        this.server.tool(
            ...
            async ({ sender, message, messageId }) => {
                ...
                Logger.mcpVerbose("Conversation message added", {
                    sender,
        ...
        this.server.tool(
            ...
            async () => {
                ...
                Logger.mcpVerbose("Full game state requested", {
                    currentX: this.state.x,
                    phase: this.gameState.currentPhase,
                });
...
`;
        ...
        // StateGraph resource
        Logger.mcpVerbose("Registering StateGraph resource", {
