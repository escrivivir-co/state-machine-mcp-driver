...
export class MCPWikiBrowserServer extends BaseMCPServer {
    ...
    private async initializeCache(): Promise<void> {
        ...
        try {
            ...
            logger.error("WikiMCP: Failed to initialize cache directory", {
                error,
            });
    ...
    private async setCachedData(
        ...
        try {
            ...
            logger.error(`WikiMCP: Failed to cache data for key ${cacheKey}`, {
                error,
            });
        }
    }
        ...
        this.server.tool(
            ...
            async ({ title, includeImages = false, language = "en" }) => {
                try {
                    ...
                    logger.error(`WikiMCP: Failed to load article "${title}"`, {
                        error,
                    });
        ...
        this.server.tool(
            ...
            async ({ query, limit = 10, language = "en" }) => {
                try {
                    ...
                    logger.error(`WikiMCP: Search failed for "${query}"`, {
                        error,
                    });
        ...
        this.server.tool(
            ...
            async ({ language = "en", namespace = 0 }) => {
                try {
                    ...
                    logger.error(`WikiMCP: Failed to get random article`, {
                        error,
                    });
