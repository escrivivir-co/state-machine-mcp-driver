...
const defaultConfig: LoggerConfig = {
    ...
    format:
        (process.env.LOG_FORMAT as "json" | "simple" | "combined") || "simple",
    verboseMode:
        process.env.MCP_VERBOSE === "true" || process.env.DEBUG === "*",
...
export const logger = winston.createLogger({
    ...
    exceptionHandlers: defaultConfig.enableFile
        ? [
              new winston.transports.File({
                  filename: `${defaultConfig.logDir}/exceptions.log`,
              }),
          ]
        : [],
    rejectionHandlers: defaultConfig.enableFile
        ? [
              new winston.transports.File({
                  filename: `${defaultConfig.logDir}/rejections.log`,
              }),
          ]
        : [],
});
